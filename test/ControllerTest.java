...
public class ControllerTest {
  ...
  @Test
  public void testTextControllerToh3() throws IOException {
    ...
    NonVisualView v = new TextDescription(model, app);
    TextController controller = new TextController(v);
    assertEquals("Shapes: \nName: disk1\nType: rectangle\nMin corner: (490, 180), "
    ...
    controller.getApp().toString());
  }

  @Test
  public void testTextViewSmallDemo() throws IOException {
  ...
  @Test
  public void testSVGViewToh3() throws IOException {
    File f = new File("toh-3.txt");
    FileReader fr = new FileReader(f);
    Animator model = AnimationReader.parseFile(fr,  new AnimationBuilderImpl());
    Appendable app = new StringBuffer();
    NonVisualView v = new SVGAnimation(model, app);
    TextController controller = new TextController(v);
  ...
  @Test
  public void SVGViewTestSmallDemo() throws IOException {
    File f = new File("smalldemo.txt");
    FileReader fr = new FileReader(f);
    Animator model = AnimationReader.parseFile(fr,  new AnimationBuilderImpl());
    Appendable app = new StringBuffer();
